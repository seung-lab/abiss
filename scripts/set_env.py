...
env = ["SCRATCH_PATH", "CHUNKMAP_PATH", "AFF_PATH", "AFF_MIP", "WS_PATH", "SEG_PATH", "WS_HIGH_THRESHOLD", "WS_LOW_THRESHOLD", "WS_SIZE_THRESHOLD", "AGG_THRESHOLD", "GT_PATH", "MYELIN_THRESHOLD"]
